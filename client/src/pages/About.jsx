...
export default function About() {
  return (
    ...
    Mumbai Estate, your premier real estate companion, redefines the art of home discovery. With an intuitive and user-friendly app, we bring the city's finest properties to your fingertips. Navigate effortlessly through our curated listings, each representing a unique blend of comfort, style, and modern living. Mumbai Estate is more than an application; it's your personalized guide to unlocking the door to dream homes. Embrace a seamless, enjoyable, and efficient property search with us as you embark on the journey to find the perfect address for your aspirations.
    </p>
    <p className='mb-4 text-slate-700'>
